...
?
select employee_id,last_name,salary,salary*commission_pct as "?곸뿬",hire_date from HR.employees;
?
select he.employee_id,he.last_name,he.salary,he.salary*commission_pct as "?곸뿬",he.hire_date from HR.employees he;
?
select department_id, employee_id, last_name, salary, salary*commission_pct as "?섎떦" from HR.employees order by salary desc, department_id asc;
?
select department_id, employee_id, last_name, salary, salary*commission_pct as "?섎떦" from HR.employees order by department_id asc;
?
select department_id, employee_id, last_name, salary, salary*commission_pct as "?섎떦" from HR.employees order by department_id asc, salary desc;
?
select department_id, employee_id, last_name, salary, salary*commission_pct as "?섎떦" from HR.employees order by salary desc, department_id asc;
?
